                    ...
                    <div class="row row-sm text-center">
                        ...
                        <div class="col-xs-6">
                            <div class="panel padder-v item bg-primary">
                                <div class="h1 text-fff font-thin h1">521</div>
                                <span class="text-muted text-xs">新增资料</span>
                                <div class="top text-right w-full">
                                    <i class="fa fa-caret-down text-warning m-r-sm"></i>
                                </div>
                            </div>
                        ...
                        <div class="col-xs-6">
                            <div class="panel padder-v item">
                                ...
                                <span class="text-muted text-xs">通知条目</span>
                            ...
                            <div class="row m-b-sm m-t-sm">
                                ...
                                <div class="col-md-11">
                                    <div class="input-group">
                                        <input type="text" placeholder="请输入搜索文件名或者通知标题" class="input-sm form-control">
                                    ...
                                    <tr>
                                        ...
                                        <td class="project-people">
                                            <a href="projects.html"><img alt="image" class="img-circle"
                                                                         src="/engine/Public/img/a3.jpg"></a>
                                            <a href="projects.html"><img alt="image" class="img-circle"
                                                                         src="/engine/Public/img/a1.jpg"></a>
                                            <a href="projects.html"><img alt="image" class="img-circle"
                                                                         src="/engine/Public/img/a2.jpg"></a>
                                            <a href="projects.html"><img alt="image" class="img-circle"
                                                                         src="/engine/Public/img/a4.jpg"></a>
                                            <a href="projects.html"><img alt="image" class="img-circle"
                                                                         src="/engine/Public/img/a5.jpg"></a>
                                        </td>
...
<!-- Flot -->
<script src="/engine/Public/js/Admin/plugins/flot/jquery.flot.js"></script>
<script src="/engine/Public/js/Admin/plugins/flot/jquery.flot.tooltip.min.js"></script>
<script src="/engine/Public/js/Admin/plugins/flot/jquery.flot.resize.js"></script>
<script src="/engine/Public/js/Admin/plugins/flot/jquery.flot.pie.js"></script>
<!-- 自定义js -->
<script src="/engine/Public/js/Admin/content.js"></script>
<!--flotdemo-->
