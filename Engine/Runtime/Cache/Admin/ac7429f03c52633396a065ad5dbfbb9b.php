...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/engine/Public/css/Admin/plugins/webuploader/webuploader.css">
    <link rel="stylesheet" type="text/css" href="/engine/Public/css/Admin/demo/webuploader-demo.css">
...
<body class="gray-bg">
    ...
    <script type="text/javascript">
        // 添加全局站点信息
        var BASE_URL = '/engine/Public/js/Admin/plugins/webuploader';
    </script>
    <script src="/engine/Public/js/Admin/plugins/webuploader/webuploader.min.js"></script>

    <script src="/engine/Public/js/Admin/demo/webuploader-demo.js"></script>
