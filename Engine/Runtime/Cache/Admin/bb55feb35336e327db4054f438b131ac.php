...
<head>
    ...
    <link href="/engine/Public/css/Admin/font-awesome.min.css?v=4.4.0" rel="stylesheet">
...
<div id="wrapper">
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                                    <span class="block m-t-xs" style="font-size:20px;">
                                        ...
                                        <strong class="font-bold">JD</strong>
                                    </span>
                                </span>
                        </a>
                    </div>
                ...
                <li>
                    <a class="J_menuItem" href="<?php echo U('Index/index_v1_');?>">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="<?php echo U('Index/AllInform');?>">
                                <i class="fa fa-envelope"></i>
                                <span class="nav-label">通知列表</span>
                                <span class="label label-warning pull-right">16</span>
                            </a>
                        </li>
                        <li>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem"  href="<?php echo U('Index/AllFile');?>">
                                <i class="fa fa-envelope"></i>
                                <span class="nav-label">文件列表</span>
                                <span class="label label-warning pull-right">16</span>
                            </a>
                        </li>
                        <li>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="<?php echo U('Index/AllReport');?>">
                                <i class="fa fa-envelope"></i>
                                <span class="nav-label">所有报表</span>
                                <span class="label label-warning pull-right">16</span>
                            </a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="mail_detail.html">发布报表</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="<?php echo U('Index/ReportManager');?>">管理报表</a>
                        </li>
                    </ul>
                </li>
                <!--设置-->
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li>
                            <a class="J_menuItem" href="mail_compose.html">文件设置</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="<?php echo U('Index/OptionReport');?>">报表设置</a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    <a class="J_menuItem" href="index_v1_.html">
                        <i class="fa fa-home"></i>
                        <span class="nav-label">主页</span>
                    </a>
                </li>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        <div class="row border-bottom">
            <nav class="navbar navbar-static-top" role="navigation" style="margin-top: 0px">
                ...
                <ul class="nav navbar-top-links navbar-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-messages">
                            <li class="m-t-xs">
                                <div class="dropdown-messages-box">
                                    <a href="profile.html" class="pull-left">
                                        <img alt="image" class="img-circle" src="/engine/Public/img/a7.jpg">
                                    </a>
                            ...
                            <li>
                                <div class="dropdown-messages-box">
                                    <a href="profile.html" class="pull-left">
                                        <img alt="image" class="img-circle" src="/engine/Public/img/a4.jpg">
                                    </a>
                                    <div class="media-body ">
                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle count-info" data-toggle="dropdown" href="#">
                            <i class="fa fa-bell"></i> <span class="label label-primary">888</span>
                        </a>
        ...
        <div class="row J_mainContent" id="content-main">
            <iframe id="J_iframe" width="100%" height="100%" src="<?php echo U('Index/index_v1');?>?v=4.0" frameborder="0"
...
<script src="/engine/Public/js/Admin/plugins/metisMenu/jquery.metisMenu.js"></script>
<script src="/engine/Public/js/Admin/plugins/slimscroll/jquery.slimscroll.min.js"></script>
<script src="/engine/Public/js/Admin/plugins/layer/layer.min.js"></script>

<!-- 自定义js -->
<script src="/engine/Public/js/Admin/hAdmin.js?v=4.1.0"></script>
<script type="text/javascript" src="/engine/Public/js/Admin/index.js"></script>

<!-- 第三方插件 -->
<script src="/engine/Public/js/Admin/plugins/pace/pace.min.js"></script>
